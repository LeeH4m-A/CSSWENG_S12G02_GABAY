export const sidebarItems = [
  { label: "Dashboard", icon: "bxs-grid-alt", href: "/dashboard", roles: ["Member","Data Encoder","Data Manager"] },
  { label: "Data Tracker", icon: "bxs-pencil", href: "/tracker", roles: ["Data Encoder","Data Manager"] },
  { label: "Data Log", icon: "bx-table", href: "/data", roles: ["Data Manager"] },
